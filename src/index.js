...
import PgDash from './views/dapp/PgDash.js';
import PgFrogeX from './views/dapp/PgFrogeX.js';
import PgEcoAction from './views/dapp/PgEcoAction.js';
import PgSponsorships from './views/dapp/PgSponsorships.js';
import PgGameNight from './views/dapp/PgGameNight.js';
import PgNFT from './views/dapp/PgNFT.js';
import PgXchange from './views/dapp/PgXchange.js';
import PgCalculators from './views/dapp/PgCalculators.js';
...
import PgUnderConstruction from './views/dapp/PgUnderConstruction.js';
