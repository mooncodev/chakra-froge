...
function walletConnectModule(options) {
  ...
  return () => {
    return {
      label: 'WalletConnect',
      getIcon: async () => (await import('../icons/wallet/walletconnect.js')).default,
      getInterface: async ({ chains, EventEmitter }) => {
        const { StaticJsonRpcProvider } = await import(
          '@ethersproject/providers'
        )

        const { ProviderRpcError, ProviderRpcErrorCode } = await import('./common.js')
