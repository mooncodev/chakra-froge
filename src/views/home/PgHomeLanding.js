...
import { NewsMarquee } from '../../components/marquee.js';
...
function PgHomeLanding() {
  ...
  return (
    ...
    >
      ...
      {/** FROGE AT A GLANCE **/}
      <VFlexCS mb='2rem'>
        <Heading as={'h1'}>Froge at-a-glance</Heading>
        <S fontSize={17}>What makes Froge the best!</S>
        <Tabs variant='soft-rounded' colorScheme='bog'
        ...
        >
          ...
          <TabPanels bgColor='bog.600' borderRadius='7px'>
            <TabPanel name='Impact'>
              <Text fontSize='lg'>There is a narrative that Crypto is a net negative, or “worse than” other forms of currency.</Text>
              <Text fontSize='sm'>Froge results in far more net positive!  Our project marks a well-defined end to that debate.</Text>
            </TabPanel>
            <TabPanel name='Community'>
            ...
            <TabPanel name='BeginnerFriendly'>
              <Text>
